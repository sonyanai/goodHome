...
public class Const {
    ...
    public static final String CompanyNumberKEY = "companyNumber";
    public static final String BitmapStringKEY = "bitmapString";
    public static final String TotalEstimateKEY = "totalEstimate";
